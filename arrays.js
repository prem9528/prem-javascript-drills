...
console.log(`lastCar's make =  ${lastCar.car_make} , and model = ${lastCar.car_model}`);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = inventory.sort((a,b) => a.car_model !== b.car_model ? a.car_model < b.car_model ? -1 : 1 : 0);
...
let BMWAndAudi =[];
for(let z of inventory){
    if(z.car_make.trim() === "BMW" ||  z.car_make.trim() === "Audi"){
        BMWAndAudi.push(z)
    }
}
